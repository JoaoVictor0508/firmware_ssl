...
static uint16_t LOW_BATT_SONG[] = {NOTE_C6, 0};

static uint16_t LOW_BATT_TEMPO[] = {2, 2};

// Underworld melody
static uint16_t marioMelodyUnderworld[] = {
...
// Underwolrd tempo
static uint16_t marioTempoUnderworld[] = {
    12, 12, 12, 12, 12, 12, 6,  3,  12, 12, 12, 12, 12, 12, 6,  3,  12, 12, 12,
    12, 12, 12, 6,  3,  12, 12, 12, 12, 12, 12, 6,  6,  18, 18, 18, 6,  6,  6,
    6,  6,  6,  18, 18, 18, 18, 18, 18, 10, 10, 10, 10, 10, 10, 3,  3,  3};

// Mario main theme melody
static uint16_t marioMelody[] = {
...
#define PWM_INIT                                                               \
    {                                                                          \
        .init = false, .frequency = 10, .counter = 10, .play = false,          \
        .pin = 0, .port = NULL, .songIndex = 0, .songSize = 0, .noteTime = 0,  \
        .noteDuration = 0, .noteEnded = true                                   \
    }
...
static PWM_t pwmBuzzer = PWM_INIT;
